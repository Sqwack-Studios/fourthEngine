...
inline void Vector3::TransformRotate(const Vector3& v, const Matrix& m, Vector3& result) noexcept
{
    using namespace DirectX;
    Vector4 v4{ &v.x };
    v4.w = 0.0f;
    const XMVECTOR V = XMLoadFloat4(&v4);
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector3 Vector3::TransformRotate(const Vector3& v, const Matrix& m) noexcept
{
    using namespace DirectX;
...
inline Matrix Matrix::CreatePerspectiveFieldOfViewReversedLH(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveFovLH(fov, aspectRatio, farPlane, nearPlane));
    return R;
}

inline Matrix Matrix::CreatePerspectiveReversedLH(float width, float height, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveLH(width, height, farPlane, nearPlane));
    return R;
}
...
inline Matrix Matrix::CreatePerspectiveOffCenterReversedLH(float left, float right, float bottom, float top, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveOffCenterLH(left, right, bottom, top, farPlane, nearPlane));
    return R;
}
...
inline Matrix Matrix::CreateOrthographicReversedLH(float width, float height, float zNearPlane, float zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixOrthographicLH(width, height, zFarPlane ,zNearPlane));
    return R;
}

inline Matrix Matrix::CreateOrthographicOffCenterReversedLH(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixOrthographicOffCenterLH(left, right, bottom, top, zFarPlane, zNearPlane));
    return R;
}
...
inline bool Plane::Intersects(const Vector3& position, const Vector3& direction, float& Dist) const noexcept
{
    using namespace DirectX;
