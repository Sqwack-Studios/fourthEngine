...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Vector3 : public XMFLOAT3
        {
...
#else
            Vector3() noexcept : XMFLOAT3(0.f, 0.f, 0.0f) {}
#endif
            ...
            static void TransformRotate(const Vector3& v, const Matrix& m, Vector3& result) noexcept;
            static Vector3 TransformRotate(const Vector3& v, const Matrix& m) noexcept;
        ...
        struct Vector4 : XMFLOAT4
        {
            ...
            Vector4(const XMFLOAT4& V) noexcept { x = V.x; y = V.y; z = V.z; w = V.w; }
            explicit Vector4(const XMVECTORF32& F) noexcept { x = F.f[0]; y = F.f[1]; z = F.f[2]; w = F.f[3]; }
            ...
            //operator Vector3() noexcept { return Vector3(&x); }
        ...
        struct Matrix : public XMFLOAT4X4
        {
            ...
            Vector4 Translation4() const  noexcept { return Vector4(_41, _42, _43, 1.0f); }
            ...
            static Matrix CreatePerspectiveFieldOfViewReversedLH(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept;
            static Matrix CreatePerspective(float width, float height, float nearPlane, float farPlane) noexcept;
            static Matrix CreatePerspectiveReversedLH(float width, float height, float nearPlane, float farPlane) noexcept;
            ...
            static Matrix CreatePerspectiveOffCenterReversedLH(float left, float right, float bottom, float top, float nearPlane, float farPlane) noexcept;
            ...
            static Matrix CreateOrthographicReversedLH(float width, float height, float zNearPlane, float zFarPlane) noexcept;
            static Matrix CreateOrthographicOffCenterReversedLH(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept;
        ...
        struct Plane : public XMFLOAT4
        {
            ...
            bool Intersects(const Vector3& position, const Vector3& direction, float& outDist) const noexcept;
