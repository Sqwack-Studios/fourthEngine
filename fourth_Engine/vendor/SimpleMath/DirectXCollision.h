...
#pragma warning(disable:4324 4820)
    ...
    struct BoundingBox
    {
        ...
        XMFLOAT3 Diagonal() const noexcept;//who the fck wrote this function????
        ...
        static BoundingBox MinMaxToExtentsCenter(_In_ XMFLOAT3 min, _In_ XMFLOAT3 Max) noexcept;
    ...
    {
        bool                    XM_CALLCONV     Intersects(_In_ FXMVECTOR Origin, _In_ FXMVECTOR Direction, _In_ FXMVECTOR V0, _In_ GXMVECTOR V1, _In_ HXMVECTOR V2, _Out_ float& Dist, _Out_ PlaneIntersectionType& outFaceIntersected) noexcept;
        // Ray-Triangle also yields plane intersected
        bool                    XM_CALLCONV     Intersects(_In_ FXMVECTOR Origin, _In_ FXMVECTOR Direction, _In_ FXMVECTOR V0, _In_ GXMVECTOR V1, _In_ HXMVECTOR V2, _Out_ FXMVECTOR& outNormal, _Out_ float& Dist, _Out_ PlaneIntersectionType& outFaceIntersected) noexcept;
        // Ray-Triangle also yields plane intersected and triangle normal
        bool                    XM_CALLCONV     Intersects(_In_ FXMVECTOR Origin, _In_ FXMVECTOR Direction, _In_ FXMVECTOR V0, _In_ GXMVECTOR V1, _In_ HXMVECTOR V2, _Out_ XMFLOAT3& outNormal, _Out_ float& Dist) noexcept;
        // Ray-Triangle also yields normal
